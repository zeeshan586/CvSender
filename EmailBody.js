const getEmailBody = (senderName, compnayName, portfolioLink) => {
...
As an experienced software engineer with a solid background in JavaScript, React. Next, Mongo, and Node.js, I am confident that I have the skills and expertise necessary to make a valuable contribution to your team. I have designed and implemented service-oriented architectures and RESTful web services using Spring Boot and Node.js.
